...
export function ManagerCheckInCard({ goal, activePeriod }: { goal: GoalWithCheckIns; activePeriod: CheckInPeriod }) {
      ...
      <div className="space-y-4 pt-2">
        {currentCheckIn?.employeeComment ? (
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-300 p-3 bg-zinc-950 rounded-md border border-zinc-800/50">
              {currentCheckIn.employeeComment}
            </p>
          </div>
        ) : (
